...
public class IAexample extends JFrame {
    ...
    public IAexample() {
        ...
        //  frame.setContentPane(new IAexample().panelMain);
        //  frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        addPlayerFormButton.addActionListener(new ActionListener() {
            @Override
        ...
        readListButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                //  loadPlayerFile();
                ...
                //    table_players.setBounds(30, 40, 200, 300);
